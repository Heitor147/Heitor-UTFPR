CREATE DATABASE  IF NOT EXISTS `granja_twink` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `granja_twink`;
-- MySQL dump 10.13  Distrib 8.0.35, for Linux (x86_64)
--
-- Host: localhost    Database: granja_twink
-- ------------------------------------------------------
...
INSERT INTO `despesas` VALUES ('2024-05-01',0,'40',36),('2024-06-05',1,'3',40),('2024-06-05',2,'1',400),('2024-06-05',3,'3',50),('2024-06-10',3,'5',20),('2024-06-10',4,'1',177.75);
/*!40000 ALTER TABLE `despesas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `despesasemumperiodo`
--

DROP TABLE IF EXISTS `despesasemumperiodo`;
/*!50001 DROP VIEW IF EXISTS `despesasemumperiodo`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `despesasemumperiodo` AS SELECT 
 1 AS `nome_insumo`,
 1 AS `nome_tipo_insumo`,
 1 AS `unidade_medida`,
 1 AS `data_despesa`,
 1 AS `valor_unidade`,
 1 AS `motivo`*/;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gastos` (
  `id_gastos` varchar(45) NOT NULL,
  `insumos_id_insumos` int NOT NULL,
  `data` date NOT NULL,
  `valor_unidade` double NOT NULL,
  `quantidade` varchar(45) NOT NULL,
  `motivo` varchar(45) NOT NULL,
  PRIMARY KEY (`insumos_id_insumos`,`id_gastos`),
...
INSERT INTO `gastos` VALUES ('1',0,'2024-05-01',36,'40','Reabastecimento'),('2',1,'2024-06-05',40,'3','Reabastecimento'),('3',2,'2024-06-05',400,'1','Reabastecimento'),('4',3,'2024-06-05',50,'3','Reabastecimento'),('5',3,'2024-06-10',20,'5','Reabastecimento'),('6',4,'2024-06-10',177.75,'1','Normas de Saúde');
...
INSERT INTO `insumos` VALUES (0,'Ração',1,2),(1,'Água',4,2),(2,'Energia',5,2),(3,'Medicamento',1,2),(4,'Vacina',0,2),(5,'Cama',2,2),(6,'Material de ninho',0,2),(7,'Equipamento',2,1),(8,'Material de limpeza',0,2),(9,'Manutenção',0,1),(10,'Mão-de-obra',0,1);
/*!40000 ALTER TABLE `insumos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `listadeinsumos`
--

DROP TABLE IF EXISTS `listadeinsumos`;
/*!50001 DROP VIEW IF EXISTS `listadeinsumos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listadeinsumos` AS SELECT 
 1 AS `nome_insumo`,
 1 AS `nome_tipo_insumo`,
 1 AS `unidade_medida`,
 1 AS `data_despesa`,
...
--
-- Final view structure for view `despesasemumperiodo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `despesasemumperiodo` AS select `insumos`.`nome_insumos` AS `nome_insumo`,`tipo_insumos`.`nome_tipo_insumos` AS `nome_tipo_insumo`,`unidade_de_medida`.`nome_unidade_de_medida` AS `unidade_medida`,`despesas`.`data_despesa` AS `data_despesa`,`gastos`.`valor_unidade` AS `valor_unidade`,`gastos`.`motivo` AS `motivo` from ((((`insumos` join `tipo_insumos` on((`insumos`.`tipo_insumos_id_tipo_insumos` = `tipo_insumos`.`id_tipo_insumos`))) join `unidade_de_medida` on((`insumos`.`unidade_de_medida_id_unidade_de_medida` = `unidade_de_medida`.`id_unidade_de_medida`))) join `despesas` on((`insumos`.`id_insumos` = `despesas`.`insumos_id_insumos`))) join `gastos` on((`despesas`.`insumos_id_insumos` = `gastos`.`insumos_id_insumos`))) where (`despesas`.`data_despesa` between '2024-06-01' and '2024-06-30') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `listadeinsumos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `listadeinsumos` AS select `insumos`.`nome_insumos` AS `nome_insumo`,`tipo_insumos`.`nome_tipo_insumos` AS `nome_tipo_insumo`,`unidade_de_medida`.`nome_unidade_de_medida` AS `unidade_medida`,`despesas`.`data_despesa` AS `data_despesa`,`gastos`.`valor_unidade` AS `valor_unidade`,`gastos`.`motivo` AS `motivo` from ((((`insumos` join `tipo_insumos` on((`insumos`.`tipo_insumos_id_tipo_insumos` = `tipo_insumos`.`id_tipo_insumos`))) join `unidade_de_medida` on((`insumos`.`unidade_de_medida_id_unidade_de_medida` = `unidade_de_medida`.`id_unidade_de_medida`))) join `despesas` on((`insumos`.`id_insumos` = `despesas`.`insumos_id_insumos`))) join `gastos` on((`despesas`.`insumos_id_insumos` = `gastos`.`insumos_id_insumos`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-06-11  9:05:05
