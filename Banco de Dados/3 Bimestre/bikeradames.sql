CREATE DATABASE  IF NOT EXISTS `bikes_radames` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bikes_radames`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: bikes_radames
-- ------------------------------------------------------
...
-- Dump completed on 2024-11-01 16:44:12
