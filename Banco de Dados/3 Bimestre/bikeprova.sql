CREATE DATABASE  IF NOT EXISTS `bikes_prova` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bikes_prova`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: bikes_prova
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `lista_produtos`
--

DROP TABLE IF EXISTS `lista_produtos`;
/*!50001 DROP VIEW IF EXISTS `lista_produtos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `lista_produtos` AS SELECT 
 1 AS `PedidoIdPedido`,
 1 AS `ProdutoIdProduto`,
 1 AS `nomeProduto`,
 1 AS `quantidade`,
 1 AS `precoUnitarioProduto`,
 1 AS `subtotal`*/;
...
--
-- Temporary view structure for view `pedidos_gerente`
--

DROP TABLE IF EXISTS `pedidos_gerente`;
/*!50001 DROP VIEW IF EXISTS `pedidos_gerente`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `pedidos_gerente` AS SELECT 
 1 AS `idPedido`,
 1 AS `dataDoPedido`,
 1 AS `nomePessoa`*/;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `precoproduto` VALUES (1,'2000-07-08 03:00:00',5),(2,'2000-07-08 03:00:00',6),(3,'2000-07-08 03:00:00',10),(4,'2024-08-27 12:10:10',18);
...
--
-- Final view structure for view `lista_produtos`
--
...
/*!50001 VIEW `lista_produtos` AS select `ph`.`PedidoIdPedido` AS `PedidoIdPedido`,`ph`.`ProdutoIdProduto` AS `ProdutoIdProduto`,`p`.`nomeProduto` AS `nomeProduto`,`ph`.`quantidade` AS `quantidade`,`ph`.`precoUnitarioProduto` AS `precoUnitarioProduto`,(`ph`.`quantidade` * `ph`.`precoUnitarioProduto`) AS `subtotal` from (`pedidohasproduto` `ph` join `produto` `p` on((`ph`.`ProdutoIdProduto` = `ph`.`ProdutoIdProduto`))) where (`ph`.`PedidoIdPedido` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `pedidos_gerente`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pedidos_gerente` AS select `p`.`idPedido` AS `idPedido`,`p`.`dataDoPedido` AS `dataDoPedido`,`pe`.`nomePessoa` AS `nomePessoa` from (`pedido` `p` join `pessoa` `pe` on((`p`.`Funcionario_Pessoa_idPessoa` = `pe`.`idPessoa`))) where (`p`.`Funcionario_Pessoa_idPessoa` = '111') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-11-01 16:43:32
